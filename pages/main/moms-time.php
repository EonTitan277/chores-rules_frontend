    ...
    <div class="card">
      <ul class="rule-list">
        ...
        <li>
          ...
          <div><strong>Chores <span class="badge badge-magenta">3, 6, and 9</span> are required during Mom's Time.</strong> You must complete these chores during the 2-hour period to unlock your reward.</div>
        </li>
        <li>
