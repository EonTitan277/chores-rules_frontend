...
<body class="has-top-menu">
  ...
  <div class="def-card blue">
    ...
    <div class="def-header">
      ...
      <h1 class="def-word">Abide</h1>
    </div>

    <p class="def-meaning">: To stay with something, follow it, or keep doing it even when it is hard</p>

    <div class="def-block def-example">
      <div class="def-block-label">Example</div>
      <p>Sarah chose to <em>abide</em> by the rules of the game.</p>
    </div>
